...
export default function App() {
  return (
    <Container w="80%" margin="0 auto">
      ...
      <Text>
        CatalogEasy（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
      </Text>
      ...
      <Text>
        当社は，ユーザーが利用登録をする際にメールアドレス、パスワードなどの個人情報をお尋ねすることがあります。
        また、ユーザーが本サービスを利用する場合、メールアドレス、パスワード、トークンなどをCookieとして収集することがあります。
        ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。
      </Text>
      <Heading as="h3" size="sm" isTruncated>
        第3条（個人情報を収集・利用する目的）
      </Heading>
      ...
      <DecimalList>
        <ListItem>
          当社は，本人から個人情報の開示を求められたときは，本人に対し、これを開示します。
      ...
      <DecimalList>
        ...
        <ListItem>
          当社は，前項の規定に基づき訂正等を行った場合，または訂正等を行わない旨の決定をしたときはこれをユーザーに通知します。
        </ListItem>
      </DecimalList>
      <Heading as="h3" size="sm" isTruncated>
        第8条（個人情報の利用停止等）
      ...
      <DecimalList>
        <ListItem>
          当社は，本人から，個人情報が，利用目的の範囲を超えて取り扱われているという理由，または不正の手段により取得されたものであるという理由により，その利用の停止または消去（以下，「利用停止等」といいます。）を求められた場合には，必要な調査を行います。
        </ListItem>
        <ListItem>
      ...
      <Text>Eメールアドレス : catalog.easy.0@gmail.com</Text>
      <Text>以上</Text>
    </Container>
  )
}
